...
local plug_map = {
  ...
  -- Plugin: hop
  ['nv|<leader><leader>w'] = map_cmd('<Cmd>HopWordMW<CR>'):with_noremap():with_desc 'jump: Goto word',
  ...
  ['nv|<leader><leader>c'] = map_cmd('<Cmd>HopChar1MW<CR>'):with_noremap():with_desc 'jump: Goto one char',
  ['nv|<leader><leader>cc'] = map_cmd('<Cmd>HopChar2MW<CR>'):with_noremap():with_desc 'jump: Goto two chars',
