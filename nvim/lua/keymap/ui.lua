...
local plug_map = {
  ...
  ['n|H'] = map_cr('BufferLineCycleNext'):with_noremap():with_silent():with_desc 'buffer: Move current to next',
  ['n|<A-k>'] = map_cr('BufferLineCyclePrev'):with_noremap():with_silent():with_desc 'buffer: Switch to prev',
  ['n|L'] = map_cr('BufferLineCyclePrev'):with_noremap():with_silent():with_desc 'buffer: Switch to prev',
  ['n|<A-S-j>'] = map_cr('BufferLineMoveNext'):with_noremap():with_silent():with_desc 'buffer: Switch to next',
