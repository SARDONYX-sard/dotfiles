...
M.plugins = {
...

  {
    ...
    config = function()
      ...
      vim.api.nvim_create_user_command('DefaultFormatToggle', function()
      ...
      local get_augroup = function(client)
        if not _augroups[client.id] then
          local group_name = 'default-lsp-format-' .. client.name
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        group = vim.api.nvim_create_augroup('default-lsp-attach-format', { clear = true }),
