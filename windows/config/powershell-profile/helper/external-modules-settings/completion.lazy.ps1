...
if ($PSVersionTable.PSEdition -eq "Core") {
  ...
  if (Get-Command docker -ErrorAction SilentlyContinue) { Import-Module DockerCompletion }
  if (Get-Command node -ErrorAction SilentlyContinue) { Import-Module npm-completion }
